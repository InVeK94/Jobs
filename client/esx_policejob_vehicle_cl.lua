...
function OpenVehicleSpawnerMenuLSPD(type, station, part, partNum)
			...
			if authorizedVehicles then
				if #authorizedVehicles > 0 then
					...
					if #shopElements > 0 then
						OpenShopMenuLSPD(shopElements, playerCoords, shopCoords)
					else
...
function OpenShopMenuLSPD(elements, restoreCoords, shopCoords)
