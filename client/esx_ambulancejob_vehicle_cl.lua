...
function OpenVehicleSpawnerMenu(type, hospital, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		if data.current.action == 'buy_vehicle' then
			local shopElements = {}
			local authorizedVehicles = Ambulancejob.AuthorizedVehicles[type][ESX.PlayerData.job.grade_name]
			local shopCoords = Ambulancejob.Hospitals[hospital][part][partNum].InsideShop
...
function GetAvailableVehicleSpawnPoint(hospital, part, partNum)
	local spawnPoints = Ambulancejob.Hospitals[hospital][part][partNum].SpawnPoints
